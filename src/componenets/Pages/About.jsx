  ...
  return (
    ...
    <div className='text-center p-2 h-auto '>
      ...
      <p>No more juggling tools, no more frustrating busy work.
         Utsaav Backstage is the fully-customizable event management platform that lets you do it all—from orbharatzing
    ...
    <p>
        Event management software is a comprehensive technology solution designed to assist event planners in orbharatzing various types of events,
    ...
    <footer className="footer relative -bottom-32">
        <p>&copy; 2024, bharat@SECE Ltd. All Rights Reserved</p>
    </footer>
    </div>
  )
}
